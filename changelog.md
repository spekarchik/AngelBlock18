...
- Shift-crafting behavior in the *Smithing Table*:
  ...
  - Shift-crafting no longer consumes **Animal Armor Handbook** when crafting armor.
...
- Fixed an issue where mod tools broke *unsupported blocks* at full speed.
...
### 🐞 Fixed
- Changes regarding the following shovels behavior: using *shovels* on **Farmland** transforms it into **Dirt Path**.
